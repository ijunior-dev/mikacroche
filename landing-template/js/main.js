...
function initChatbot() {
  ...
  const steps = [
    {
      msg: 'Olá! 👋 Posso te ajudar a encontrar o móvel ideal?',
      type: 'options',
    ...
    },
    {
      ...
      type: 'options',
      options: ['🍳 Cozinha', '🛏 Quarto', '💼 Escritório', '🛋 Sala'],
    ...
    {
      msg: `Que ótimo, ${() => chatData.nome}! 🎉 Vou te conectar com nosso especialista agora.`,
      type: 'cta',
    },
  ];
